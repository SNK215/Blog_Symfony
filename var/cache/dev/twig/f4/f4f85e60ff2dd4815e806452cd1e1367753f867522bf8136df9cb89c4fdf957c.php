...
class __TwigTemplate_84f02ab8df99357e46f381ff1e09f4780f55de28bc880bf356056e10cde3e38c extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "email", [], "any", false, false, false, 10), 'row', ["label" => "Adresse mail", "attr" => ["placeholder" => "Votre adresse mail..."]]);
        echo "
    ";
        // line 11
    ...
    ";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "confirm_password", [], "any", false, false, false, 12), 'row', ["label" => "Confirmation du mot de passe", "attr" => ["placeholder" => "Confirmez le mot de passe..."]]);
        echo "
...
";
    ...
    {
        return array (  96 => 15,  90 => 12,  86 => 11,  82 => 10,  78 => 9,  73 => 7,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    {{form_row(form.password, {\"label\": \"Mot de passe\",\"attr\" : {\"placeholder\" : \"Votre mot de passe...\"}})}}
    {{form_row(form.confirm_password, {\"label\": \"Confirmation du mot de passe\",\"attr\" : {\"placeholder\" : \"Confirmez le mot de passe...\"}})}}

    <button type=\"submit\" class=\"btn btn-success\">Valider l'inscription</button>
    {{form_end(form)}}

{% endblock %}", "security/registration.html.twig", "C:\\Users\\User1\\Documents\\Projet_Symfony\\Blog_Symfony\\templates\\security\\registration.html.twig");
    }
}
